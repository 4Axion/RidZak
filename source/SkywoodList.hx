...
class SkywoodList extends MusicBeatState
{
	var songs:Array<FSongMetadata> = [];
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In the Menus", null);
				...
				addSong('Scarlet', -1, 'meno', FlxColor.fromRGB(255, 87, 51));
		...
		bg = new FlxSprite().loadGraphic(Paths.image('Blue1', 'ridzak'));
	...
	{
		songs.push(new FSongMetadata(songName, weekNum, songCharacter, color));
	}
	...
	override function update(elapsed:Float)
	{
		...
		else if (accepted)
		{
			...
			PlayState.returnstate = function(){
				...
				FlxG.switchState(new SkywoodList());
			};
