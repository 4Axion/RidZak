...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		//if (_song.player2 == 'ridzak-pminus' && !FlxG.save.data.minusUnlocked == true)
		//	System.exit(0); too much trolling !
