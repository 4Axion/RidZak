...
class Paths
{
	...
	inline static public function introAnim(key:String)
	{
		return getPath('startStuff/$key.txt', TEXT, 'dialogue');
	}

	inline static public function newDialogue(key:String)
	{
		return getPath('textDialogue/$key.txt', TEXT, 'dialogue');
	}

	inline static public function newDialogueEnd(key:String)
	{
		return getPath('textDialogue/$key-end.txt', TEXT, 'dialogue');
	}

	inline static public function level(key:String, ?library:String)
	{
		return getPath('data/$key.txt', TEXT, library);
	}
